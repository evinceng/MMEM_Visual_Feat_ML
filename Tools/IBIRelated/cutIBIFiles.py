...
userSensorContentFileName =  "C:/Users/evinao/Dropbox (Lucami)/LivingLab MMEM data/MetaData/userContentSensorDict.csv"
...
for selectedContent in contentList:
    ...
    for cuID in filteredUserList:
        ...
        if isNotEmpty:
            ...
            Path(outputFolder+cutDfFolder).mkdir(parents= True, exist_ok = True)
