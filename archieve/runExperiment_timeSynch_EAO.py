...
rawDataRootFolder = 'D:/LivingLabMeasurements/'
...
# Utils.fillAbsStartTimesOfSensors(rawDataRootFolder, filesFoldersDictFileName)
...
# if readDataQ:
dfDict = generateTimeStampedDFs.loadData(uID, rawDataRootFolder, filesFoldersDictFileName)
